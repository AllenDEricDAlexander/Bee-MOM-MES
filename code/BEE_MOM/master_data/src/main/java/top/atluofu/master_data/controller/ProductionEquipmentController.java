 ...
 */
@Tag(name = "ProductionEquipmentController模块")
@RestController
@Slf4j
@Validated
@RequestMapping("productionEquipment")
public class ProductionEquipmentController {
    ...
    public ResultUtils selectOne(@PathVariable Serializable id) {
        return ResultUtils.success(this.productionEquipmentService.getById(id));
    }

    /**
     * 新增数据
     *
     * @param productionEquipment 实体对象
     * @return 新增结果
     */
    @PostMapping
    ...
    public ResultUtils delete(@RequestParam("idList") List<Long> idList) {
        return ResultUtils.success(this.productionEquipmentService.removeByIds(idList));
    }
}
