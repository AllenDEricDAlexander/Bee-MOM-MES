...
public interface PurchaseReturnDao extends BaseMapper<PurchaseReturnPO> {
     ...
     *
     * @param entities List<PurchaseReturn> 实例对象列表
     * @return 影响行数
     */
    int insertBatch(@Param("entities") List<PurchaseReturnPO> entities);
     ...
     */
    int insertOrUpdateBatch(@Param("entities") List<PurchaseReturnPO> entities);
